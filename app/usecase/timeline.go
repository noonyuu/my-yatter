...
func (t *timeline) GetPublicTimeline(ctx context.Context, maxId, sinceId, limit string) (*GetPublicStatusDTO, error) {
	...
	// statusの取得
	sta, err := t.tr.GetPublicTimeline(ctx, maxID, sinceID, lmt)
	if err != nil {
		return nil, err
	}
